...
namespace DroidTreeView_Sample.Fragments
{
    ...
    public class TwoDScrollingFragment : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            TreeNode s1 = new TreeNode(new IconTreeItem(Resource.String.ic_folder, "Folder with very long name ")).SetViewHolder(new SelectableHeaderHolder(Activity));
            TreeNode s2 = new TreeNode(new IconTreeItem(Resource.String.ic_folder, "Another folder with very long name")).SetViewHolder(new SelectableHeaderHolder(Activity));
        ...
        private void fillFolder(TreeNode folder)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                TreeNode file = new TreeNode(new IconTreeItem(Resource.String.ic_folder, NAME)).SetViewHolder(new SelectableHeaderHolder(Activity));
